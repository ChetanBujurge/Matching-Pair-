//shuffle array of emoji
var emoji = ["💐","🌹","🌻","🏵","🌺","🌴","🌈","🍓","🍒","🍎","🍉","🍊","🥭","🍍","🍋","🍏","🍐","🥝","🍇","🥥","🍅","🌶","🍄","🧅","🥦","🥑","🍔","🍕","🧁","🎂","🍬","🍩","🍫","🎈"];
var temp, c, p = emoji.length;
if(p) while(--p) {
...
window.onload = function() 
{
    ...
    <button class="button" onclick="start(3, 4)">3 x 4</button> 
    <button class="button" onclick="start(4, 4)">4 x 4</button>
    <button class="button" onclick="start(4, 5)">4 x 5</button>
    <button class="button" onclick="start(5, 6)">5 x 6</button>
    <button class="button" onclick="start(6, 6)">6 x 6</button>
    </center>`);
}
...
// timer
function myFunction() {
    setInterval(setAlert, 15000);
}

//random

//instructions_welcome page
...
function change(x) {
    //Variables
    let i = "#"+x+" .inner"; //#2.inner
    let f = "#"+x+" .inner .front"; //#2.inner.front
    let b = "#"+x+" .inner .back"; //#2.inner.back
